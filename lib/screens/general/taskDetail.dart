...
class DetailScreen extends anxeb.ScreenWidget {
  ...
  @override
  anxeb.ScreenView<DetailScreen, Application> createState() => _DetailState();
}

class _DetailState extends anxeb.ScreenView<DetailScreen, Application> {
